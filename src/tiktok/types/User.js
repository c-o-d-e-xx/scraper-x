...
class User {
   ...
   * @param {string} tiktokLink - The absolute link of this user's TikTok
   * @param {string} thumbnail - The thumbnail of the user's TikTok
   */
  constructor(
    id,
    uniqueId,
    ...
    this.tiktokLink = tiktokLink; // Absolute link to TikTok
    this.thumbnail = thumbnail; // Thumbnail of the user's TikTok
  }
}
